...

{
  ...
  Rat_Data_Load <- function(path.to.files){
    ...
    # 
    # names(rat.data) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight" , "Weight", "Dose.Amount", "Color")
    # 
    # Female.IV.Rat1 <- rat.data[ which(rat.data$Sex == 'Female' & rat.data$Rat == 'Rat1'), ]
    # Female.IV.Rat2 <- rat.data[ which(rat.data$Sex == 'Female' & rat.data$Rat == 'Rat2'), ]
    # Female.IV.Rat3 <- rat.data[ which(rat.data$Sex == 'Female' & rat.data$Rat == 'Rat3'), ]
    # Female.IV.Rat4 <- rat.data[ which(rat.data$Sex == 'Female' & rat.data$Rat == 'Rat4'), ]
    # Female.IV.Rat5 <- rat.data[ which(rat.data$Sex == 'Female' & rat.data$Rat == 'Rat5'), ]
    # Male.IV.Rat1   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat1'), ]
    # Male.IV.Rat2   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat2'), ]
    # Male.IV.Rat3   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat3'), ]
    # Male.IV.Rat4   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat4'), ]
    # Male.IV.Rat5   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat5'), ]
    # Male.IV.Rat6   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat6'), ]
    # Male.IV.Rat7   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat7'), ]
    # Male.IV.Rat8   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat8'), ]
    # Male.IV.Rat9   <- rat.data[ which(rat.data$Sex == 'Male'   & rat.data$Rat == 'Rat9'), ]
    # 
    # names(Female.IV.Rat1) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Female.IV.Rat2) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Female.IV.Rat3) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Female.IV.Rat4) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Female.IV.Rat5) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat1) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat2) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat3) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat4) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat5) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat6) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat7) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat8) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # names(Male.IV.Rat9) <- c("Time.hr", "conc.C_Pentration.muM", "Rat", "Sex", "Injection.Type", "UniqueID", "Molecular.Weight", "Weight", "Dose.Amount", "Color")
    # 
    # Female.IV.Rat1 <- data.frame(Female.IV.Rat1$Time.hr, Female.IV.Rat1$conc.C_Pentration.muM, Female.IV.Rat1$Weight*Female.IV.Rat1$Dose.Amount/Female.IV.Rat1$Molecular.Weight*1e9)
    # Female.IV.Rat2 <- data.frame(Female.IV.Rat2$Time.hr, Female.IV.Rat2$conc.C_Pentration.muM, Female.IV.Rat2$Weight*Female.IV.Rat2$Dose.Amount/Female.IV.Rat2$Molecular.Weight*1e9)
    # Female.IV.Rat3 <- data.frame(Female.IV.Rat3$Time.hr, Female.IV.Rat3$conc.C_Pentration.muM, Female.IV.Rat3$Weight*Female.IV.Rat3$Dose.Amount/Female.IV.Rat3$Molecular.Weight*1e9)
    # Female.IV.Rat4 <- data.frame(Female.IV.Rat4$Time.hr, Female.IV.Rat4$conc.C_Pentration.muM, Female.IV.Rat4$Weight*Female.IV.Rat4$Dose.Amount/Female.IV.Rat4$Molecular.Weight*1e9)
    # Female.IV.Rat5 <- data.frame(Female.IV.Rat5$Time.hr, Female.IV.Rat5$conc.C_Pentration.muM, Female.IV.Rat5$Weight*Female.IV.Rat5$Dose.Amount/Female.IV.Rat5$Molecular.Weight*1e9)
    # Male.IV.Rat1 <- data.frame(Male.IV.Rat1$Time.hr, Male.IV.Rat1$conc.C_Pentration.muM, Male.IV.Rat1$Weight*Male.IV.Rat1$Dose.Amount/Male.IV.Rat1$Molecular.Weight*1e9)
    # Male.IV.Rat2 <- data.frame(Male.IV.Rat2$Time.hr, Male.IV.Rat2$conc.C_Pentration.muM, Male.IV.Rat2$Weight*Male.IV.Rat2$Dose.Amount/Male.IV.Rat2$Molecular.Weight*1e9)
    # Male.IV.Rat3 <- data.frame(Male.IV.Rat3$Time.hr, Male.IV.Rat3$conc.C_Pentration.muM, Male.IV.Rat3$Weight*Male.IV.Rat3$Dose.Amount/Male.IV.Rat3$Molecular.Weight*1e9)
    # Male.IV.Rat4 <- data.frame(Male.IV.Rat4$Time.hr, Male.IV.Rat4$conc.C_Pentration.muM, Male.IV.Rat4$Weight*Male.IV.Rat4$Dose.Amount/Male.IV.Rat4$Molecular.Weight*1e9)
    # Male.IV.Rat5 <- data.frame(Male.IV.Rat5$Time.hr, Male.IV.Rat5$conc.C_Pentration.muM, Male.IV.Rat5$Weight*Male.IV.Rat5$Dose.Amount/Male.IV.Rat5$Molecular.Weight*1e9)
    # Male.IV.Rat6 <- data.frame(Male.IV.Rat6$Time.hr, Male.IV.Rat6$conc.C_Pentration.muM, Male.IV.Rat6$Weight*Male.IV.Rat6$Dose.Amount/Male.IV.Rat6$Molecular.Weight*1e9)
    # Male.IV.Rat7 <- data.frame(Male.IV.Rat7$Time.hr, Male.IV.Rat7$conc.C_Pentration.muM, Male.IV.Rat7$Weight*Male.IV.Rat7$Dose.Amount/Male.IV.Rat7$Molecular.Weight*1e9)
    # Male.IV.Rat8 <- data.frame(Male.IV.Rat8$Time.hr, Male.IV.Rat8$conc.C_Pentration.muM, Male.IV.Rat8$Weight*Male.IV.Rat8$Dose.Amount/Male.IV.Rat8$Molecular.Weight*1e9)
    # Male.IV.Rat9 <- data.frame(Male.IV.Rat9$Time.hr, Male.IV.Rat9$conc.C_Pentration.muM, Male.IV.Rat9$Weight*Male.IV.Rat9$Dose.Amount/Male.IV.Rat9$Molecular.Weight*1e9)
    # 
    # names(Female.IV.Rat1) <- c("time", "conc.C_P", "D_0")
    # names(Female.IV.Rat2) <- c("time", "conc.C_P", "D_0")
    # names(Female.IV.Rat3) <- c("time", "conc.C_P", "D_0")
    # names(Female.IV.Rat4) <- c("time", "conc.C_P", "D_0")
    # names(Female.IV.Rat5) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat1) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat2) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat3) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat4) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat5) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat6) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat7) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat8) <- c("time", "conc.C_P", "D_0")
    # names(Male.IV.Rat9) <- c("time", "conc.C_P", "D_0")
    # 
    # ### Truncates the data (deletes the data prior to the max conc.C_Pentration)
    # Female.IV.Rat1 <- Female.IV.Rat1[-1:-(which(Female.IV.Rat1$conc.C_P==max(Female.IV.Rat1$conc.C_P))-1),]
    # Female.IV.Rat2 <- Female.IV.Rat2[-1:-(which(Female.IV.Rat2$conc.C_P==max(Female.IV.Rat2$conc.C_P))-1),]
    # Female.IV.Rat3 <- Female.IV.Rat3[-1:-(which(Female.IV.Rat3$conc.C_P==max(Female.IV.Rat3$conc.C_P))-1),]
    # Female.IV.Rat4 <- Female.IV.Rat4[-1:-(which(Female.IV.Rat4$conc.C_P==max(Female.IV.Rat4$conc.C_P))-1),]
    # Female.IV.Rat5 <- Female.IV.Rat5[-1:-(which(Female.IV.Rat5$conc.C_P==max(Female.IV.Rat5$conc.C_P))-1),]
    # Male.IV.Rat1 <- Male.IV.Rat1[-1:-(which(Male.IV.Rat1$conc.C_P==max(Male.IV.Rat1$conc.C_P))-1),]
    # Male.IV.Rat2 <- Male.IV.Rat2[-1:-(which(Male.IV.Rat2$conc.C_P==max(Male.IV.Rat2$conc.C_P))-1),]
    # Male.IV.Rat3 <- Male.IV.Rat3[-1:-(which(Male.IV.Rat3$conc.C_P==max(Male.IV.Rat3$conc.C_P))-1),]
    # Male.IV.Rat4 <- Male.IV.Rat4[-1:-(which(Male.IV.Rat4$conc.C_P==max(Male.IV.Rat4$conc.C_P))-1),]
    # Male.IV.Rat5 <- Male.IV.Rat5[-1:-(which(Male.IV.Rat5$conc.C_P==max(Male.IV.Rat5$conc.C_P))-1),]
    # Male.IV.Rat6 <- Male.IV.Rat6[-1:-(which(Male.IV.Rat6$conc.C_P==max(Male.IV.Rat6$conc.C_P))-1),]
    # Male.IV.Rat7 <- Male.IV.Rat7[-1:-(which(Male.IV.Rat7$conc.C_P==max(Male.IV.Rat7$conc.C_P))-1),]
    # Male.IV.Rat8 <- Male.IV.Rat8[-1:-(which(Male.IV.Rat8$conc.C_P==max(Male.IV.Rat8$conc.C_P))-1),]
    # Male.IV.Rat9 <- Male.IV.Rat9[-1:-(which(Male.IV.Rat9$conc.C_P==max(Male.IV.Rat9$conc.C_P))-1),]
    # 
    # rownames(Female.IV.Rat1) <- seq(length=nrow(Female.IV.Rat1))
    # rownames(Female.IV.Rat2) <- seq(length=nrow(Female.IV.Rat2))
    # rownames(Female.IV.Rat3) <- seq(length=nrow(Female.IV.Rat3))
    # rownames(Female.IV.Rat4) <- seq(length=nrow(Female.IV.Rat4))
    # rownames(Female.IV.Rat5) <- seq(length=nrow(Female.IV.Rat5))
    # rownames(Male.IV.Rat1) <- seq(length=nrow(Male.IV.Rat1))
    # rownames(Male.IV.Rat2) <- seq(length=nrow(Male.IV.Rat2))
    # rownames(Male.IV.Rat3) <- seq(length=nrow(Male.IV.Rat3))
    # rownames(Male.IV.Rat4) <- seq(length=nrow(Male.IV.Rat4))
    # rownames(Male.IV.Rat5) <- seq(length=nrow(Male.IV.Rat5))
    # rownames(Male.IV.Rat6) <- seq(length=nrow(Male.IV.Rat6))
    # rownames(Male.IV.Rat7) <- seq(length=nrow(Male.IV.Rat7))
    # rownames(Male.IV.Rat8) <- seq(length=nrow(Male.IV.Rat8))
    # rownames(Male.IV.Rat9) <- seq(length=nrow(Male.IV.Rat9))
    # 
    # Female.IV.Rat1$time <- Female.IV.Rat1$time - min(Female.IV.Rat1$time)
    # Female.IV.Rat2$time <- Female.IV.Rat2$time - min(Female.IV.Rat2$time)
    # Female.IV.Rat3$time <- Female.IV.Rat3$time - min(Female.IV.Rat3$time)
    # Female.IV.Rat4$time <- Female.IV.Rat4$time - min(Female.IV.Rat4$time)
    # Female.IV.Rat5$time <- Female.IV.Rat5$time - min(Female.IV.Rat5$time)
    # Male.IV.Rat1$time <- Male.IV.Rat1$time - min(Male.IV.Rat1$time)
    # Male.IV.Rat2$time <- Male.IV.Rat2$time - min(Male.IV.Rat2$time)
    # Male.IV.Rat3$time <- Male.IV.Rat3$time - min(Male.IV.Rat3$time)
    # Male.IV.Rat4$time <- Male.IV.Rat4$time - min(Male.IV.Rat4$time)
    # Male.IV.Rat5$time <- Male.IV.Rat5$time - min(Male.IV.Rat5$time)
    # Male.IV.Rat6$time <- Male.IV.Rat6$time - min(Male.IV.Rat6$time)
    # Male.IV.Rat7$time <- Male.IV.Rat7$time - min(Male.IV.Rat7$time)
    # Male.IV.Rat8$time <- Male.IV.Rat8$time - min(Male.IV.Rat8$time)
    # Male.IV.Rat9$time <- Male.IV.Rat9$time - min(Male.IV.Rat9$time)
    # 
    # # creating, and naming elements in a list containing all the IV Rat data after truncation
    # rat_list_full <- list(Female.IV.Rat1 = Female.IV.Rat1,
    #                       Female.IV.Rat2 = Female.IV.Rat2,
    #                       Female.IV.Rat3 = Female.IV.Rat3,
    #                       Female.IV.Rat4 = Female.IV.Rat4,
    #                       Female.IV.Rat5 = Female.IV.Rat5,
    #                       Male.IV.Rat1 = Male.IV.Rat1,
    #                       Male.IV.Rat2 = Male.IV.Rat2,
    #                       Male.IV.Rat3 = Male.IV.Rat3,
    #                       Male.IV.Rat4 = Male.IV.Rat4,
    #                       Male.IV.Rat5 = Male.IV.Rat5,
    #                       Male.IV.Rat6 = Male.IV.Rat6,
    #                       Male.IV.Rat7 = Male.IV.Rat7,
    #                       Male.IV.Rat8 = Male.IV.Rat8,
    #                       Male.IV.Rat9 = Male.IV.Rat9)
    # 
    # Female.IV.Rat1 <- Female.IV.Rat1[Female.IV.Rat1$time <= 2.2,]
    # Female.IV.Rat2 <- Female.IV.Rat2[Female.IV.Rat2$time <= 2.2,]
    # Female.IV.Rat3 <- Female.IV.Rat3[Female.IV.Rat3$time <= 2.2,]
    # Female.IV.Rat4 <- Female.IV.Rat4[Female.IV.Rat4$time <= 2.2,]
    # Female.IV.Rat5 <- Female.IV.Rat5[Female.IV.Rat5$time <= 2.2,]
    # Male.IV.Rat1 <- Male.IV.Rat1[Male.IV.Rat1$time <= 2.2,]
    # Male.IV.Rat2 <- Male.IV.Rat2[Male.IV.Rat2$time <= 2.2,]
    # Male.IV.Rat3 <- Male.IV.Rat3[Male.IV.Rat3$time <= 2.2,]
    # Male.IV.Rat4 <- Male.IV.Rat4[Male.IV.Rat4$time <= 2.2,]
    # Male.IV.Rat5 <- Male.IV.Rat5[Male.IV.Rat5$time <= 2.2,]
    # Male.IV.Rat6 <- Male.IV.Rat6[Male.IV.Rat6$time <= 2.2,]
    # Male.IV.Rat7 <- Male.IV.Rat7[Male.IV.Rat7$time <= 2.2,]
    # Male.IV.Rat8 <- Male.IV.Rat8[Male.IV.Rat8$time <= 2.2,]
    # Male.IV.Rat9 <- Male.IV.Rat9[Male.IV.Rat9$time <= 2.2,]
    # 
    # # creating, and naming elements in a list containing all the IV Rat data after truncation
    # rat_list <- list(Female.IV.Rat1 = Female.IV.Rat1,
    #                  Female.IV.Rat2 = Female.IV.Rat2,
    #                  Female.IV.Rat3 = Female.IV.Rat3,
    #                  Female.IV.Rat4 = Female.IV.Rat4,
    #                  # Female.IV.Rat5 = Female.IV.Rat5, # removed due to obs occurring <1 hr.
    #                  Male.IV.Rat1 = Male.IV.Rat1,
    #                  Male.IV.Rat2 = Male.IV.Rat2,
    #                  Male.IV.Rat3 = Male.IV.Rat3,
    #                  Male.IV.Rat4 = Male.IV.Rat4,
    #                  Male.IV.Rat5 = Male.IV.Rat5,
    #                  # Male.IV.Rat6 = Male.IV.Rat6, # removed due to obs occurring <1 hr.
    #                  # Male.IV.Rat7 = Male.IV.Rat7, # removed due to obs occurring <1 hr.
    #                  Male.IV.Rat8 = Male.IV.Rat8
    #                  # ,
    #                  # Male.IV.Rat9 = Male.IV.Rat9 # removed due to obs occurring <1 hr.
    # )
